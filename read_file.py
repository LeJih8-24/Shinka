...
clean_names = ['BORDEAUX ST JEAN', 'LA ROCHELLE VILLE', 'PARIS MONTPARNASSE', 'QUIMPER', 'TOURS', 'ST PIERRE DES CORPS', 'ST MALO', 'NANTES', 'PARIS EST', 'STRASBOURG', 'DUNKERQUE', 'LILLE', 'PARIS VAUGIRARD', 'RENNES', 'TOURCOING', 'CHAMBERY CHALLES LES EAUX', 'LYON PART DIEU', 'MONTPELLIER', 'MULHOUSE VILLE', 'NICE VILLE', 'PARIS LYON', 'BARCELONA', 'GENEVE', 'MADRID', 'BREST', 'POITIERS', 'TOULOUSE MATABIAU', 'MARNE LA VALLEE', 'MARSEILLE ST CHARLES', 'FRANCFORT', 'ANGOULEME', 'METZ', 'PARIS NORD', 'BELLEGARDE (AIN)', 'MACON LOCHE', 'PERPIGNAN', 'DOUAI', 'VALENCE ALIXAN TGV', 'LAUSANNE', 'ANGERS SAINT LAUD', 'STUTTGART', 'LAVAL', 'NANCY', 'BESANCON FRANCHE COMTE TGV', 'GRENOBLE', 'NIMES', 'SAINT ETIENNE CHATEAUCREUX', 'ITALIE', 'ZURICH', 'VANNES', 'ANNECY', 'AVIGNON TGV', 'MADRID', 'LE MANS', 'ST MALO', 'ARRAS', 'DIJON VILLE', 'LE CREUSOT MONTCEAU MONTCHANIN', 'REIMS']
